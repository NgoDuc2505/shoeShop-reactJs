...
export default function ShoeStore(prop) {
  const shoeList = [
    {
      "id": 1,
  ...
  let [productShoe, setShoe] = useState(shoeList[1])
  //props model & control below are using for open/close model when users click at 'show detail' & 'close' buttons.
  let [modelOpen, setModelOpen] = useState(true)
  ...
  return (
    <div className="container-lg my-5" id='shoeList'>
      <div className='shoeStore'>
        ...
        />
        <Modal data={productShoe} model={modelOpen} control={setModelOpen} />
        <Cart
          cartClose={prop.cartClose}
          setCartClose={prop.setCartClose}
          cart={prop.cart}
          setCart={prop.setCart}
          empty={prop.empty}
          setEmpty={prop.setEmpty}
